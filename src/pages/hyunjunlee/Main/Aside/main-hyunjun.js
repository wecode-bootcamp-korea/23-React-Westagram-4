        ...
        <div className="mainArticles">
          <div className="feeds">
            <article className="article">
              ...
              <div className="iconContainer">
                <ul className="icons">
                  <li><img className="hearticon" alt="heartIcon" src="img/heart.png" /></li>
                  <li><i className="far fa-comment"></i></li>
                  <li><i className="far fa-share-square"></i></li>
                </ul>
              ...
              <div className="desContainer">
                ...
                <p className="description"><b>hyonii_xx</b> 저 오늘 졸업했어요. 2019년 2월 졸업이었는데 코로나때문에 졸업이 연기되면서 2019년 7월 졸업식에 참여했어요.
                  졸업식 가운을 입고 열심히 돌아다니는데 땀 퐁퐁퐁.. 이 더위를 식혀줄 무언가가 필요해;;</p>
                <p className="time">41분 전</p>
              </div>
              <div className="replyContainer">
                <i className="far fa-grin"></i>
                <input className="reply" type="text" placeholder="댓글 달기..." />
          ...
          <div className="main-right">
            <div className="accounts">
              ...
              <p className="accountName"><b>hyonii_xx</b><br />바리바리짱바리</p>
              ...
              <div className="recommendationContainer">
                ...
                <div className="recommendations">
                  <div className="recommendation1">
                    ...
                    <p className="storyid"><b>dongne43</b></p>
                    <p className="follow">팔로우</p>
                  </div>
                  <div className="recommendation2">
                    <img alt="foryouProfile2" src="img/foryou2.jpg" />
                    <p className="storyid"><b>chell_ta2</b></p>
                    <p className="follow">팔로우</p>
                  </div>
                  <div className="recommendation3">
                    <img alt="foryouProfile3" src="img/foryou3.jpg" />
                    <p className="storyid"><b>h_tae0</b></p>
                    <p className="follow">팔로우</p>
                  </div>
                </div>
              </div>
            </div>
            <p className="rights">소개, 도움말, 홍보센터, API, 채용정보,<br /> 개인정보처리방침, 양관, 위치,계정, 해시태그, 언어</p>
            <br />
