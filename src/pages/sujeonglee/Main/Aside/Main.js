                ...
                <article>
                        ...
                        <div className="profileArticle">
                            <div className="mainId">
                                <div className="profileImgBox">
                                    <img alt="프로필사진" src="https://pbs.twimg.com/profile_images/1388372006597324803/vOGAnpoN_400x400.jpg"  className="profileImg"/>
                                </div>
                            ...
                            <div className="profileIcon">
                                <img alt="정보아이콘" src="images/more.png" className="moreIcon"/>
                            </div>
                        </div>
                    </header>
                    <div className="mainImgBox">
                        <img alt="피드이미지" src="https://imgc.1300k.com/aaaaaib/goods/215024/71/215024713100.jpg?3" className="mainImg"/>
                    </div>
                    ...
                    <div className="feedLike">
                        <div className="likeImgBox">
                            <img alt="좋아요" src="http://www.jjn.co.kr/news/photo/201905/773960_123602_629.jpg"  className="likeImg"/>
                        </div>  
                        <span className="likeInfo">
                            <a href="#"><span>k_rystalee</span>님 <span>외 10명</span>이 좋아합니다</a>    
                        </span>
                    </div>
                        <div className="commentRow">
                                ...
                                <ul className="newComment">    
                                    <li className="newCommentList">
                                        <span className="commentText"><span className="commenetUserId">sujeong</span>위코드 위스타그램 클린코딩!~~</span>
                                        <span className="newCommentIcon">
                                            <img alt="하트" src="images/heart.png"  className="commentHeart"/>
                        ...
                        <div className="commentContainer">
                            <input type="text" placeholder="댓글 달기..." className="commentBox"/> 
                            <button type="submit" className="commentSubmit" disabled>게시</button>
                        </div>
                </article>
            </div>
            <div className="mainRight">
                <div className="myprofile">
                    <div className="myprofileRight">
                        <img alt="프로필이미지" src="https://pbs.twimg.com/profile_images/1388372006597324803/vOGAnpoN_400x400.jpg"  className="profileImg"/>
                    </div>
                ...
                <div className="story">
                  ...
                  <div className="information">
                      <span>Westagram 정보, 지원, 홍보센터, API, 채용 정보, 개인정보처리방침, 약관, 디렉터리, 프로필, 해시태그 ,언어</span>
